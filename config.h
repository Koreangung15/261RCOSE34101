...
#define CPU_BOUND_CPU_MAX 10
#define CPU_BOUND_IO_MIN 5
#define CPU_BOUND_IO_MAX 10
#define CPU_BOUND_IO_CYCLE_MIN 0
#define CPU_BOUND_IO_CYCLE_MAX 2

#define IO_BOUND_CPU_MIN 3
#define IO_BOUND_CPU_MAX 8
#define IO_BOUND_IO_MIN 8
#define IO_BOUND_IO_MAX 13
#define IO_BOUND_IO_CYCLE_MIN 1
#define IO_BOUND_IO_CYCLE_MAX 3
